...
export default class Splash {
	constructor({ app_version = "alpha 0.1" } = {}) {
		html`
				...
				<div id="Splash-Overlay-Dismisser" this="autoplay_tap">
					...
					<div class="Greet" this="greet">
						<div class="appName-container">
							<p this="logo a" class="appName-base">${document.title}</p>
							<p this="logo b" class="appName">${document.title}</p>
						</div>
...
zyxcss.path("https://zyx.wumbl3.xyz/v:1.4/_/Splash/zyX-Splash.css");
